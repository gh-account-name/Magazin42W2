...
@section('main')
    <div class="container" id="regApp">
        <div class="row justify-content-center"><h2 class="text-center m-5 text-white">Регистрация</h2></div>
        <div class="row justify-content-center">
            <form class="col-5" id="form" @submit.prevent="Registration">
                ...
                <div class="mb-3">
                    <label for="patronymic" class="form-label text-white">Отчество</label>
                ...
                <div class="mb-3">
                    <label for="password_confirmation" class="form-label text-white">Повторение пароля</label>
                    <input type="password" class="form-control" name="password_confirmation">
                </div>
                <div class="mb-3 form-check">
                    <input type="checkbox" class="rules" id="rules" name="rules" :class="errors.rules ? 'is-invalid' : '' ">
                    <label class="form-check-label text-white" for="rules" style="margin-left: 5px; cursor:pointer">Согласие на обработку данных</label>
